...
export function initLevelUpBabylonDemo({scene, camera, batchRenderer, systems, demoState}) {
    ...
    gatherParticles.addBehavior(new ColorOverLife(new ColorRange(new Vector4(0.2, 0.2, 0.2, 1), new Vector4(1, 1, 1, 1))));
...
export function updateLevelUpBabylonDemo({demoState}, delta) {
