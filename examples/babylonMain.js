...
const GITHUB_BASE = 'https://github.com/Soullnik/babylon.quarks-standalone/blob/main/examples/';
...
demoSelect.addEventListener('change', (event) => {
    ...
    const selectedIndex = babylonDemos.findIndex((demoItem) => demoItem.key === selectedKey);
    if (selectedIndex >= 0) {
