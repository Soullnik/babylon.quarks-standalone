...
export function init({scene, camera, batchRenderer, systems}: DemoContext) {
    ...
    for (let i = 0; i < 100; i++) {
        ...
        flash.addBehavior(createColorOverLifeRange(new Vector4(1, 0.95, 0.82, 1), new Vector4(1, 0.38, 0.12, 1)));
        ...
        smoke.addBehavior(createColorOverLifeRange(new Vector4(1, 1, 1, 1), new Vector4(1, 1, 1, 0)));
